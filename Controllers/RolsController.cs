...
namespace Tareasv2.Controllers
{
    public class RolsController : Controller
    {
        ...
        public RolsController(TareasDBv3Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Rols != null ? 
                          ...
                          Problem("Entity set 'TareasDBv3Context.Rols'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TareasDBv3Context.Rols'  is null.");
            }
            var rol = await _context.Rols.FindAsync(id);
            if (rol != null)
            {
