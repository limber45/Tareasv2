...
namespace Tareasv2.Controllers
{
    public class GruposController : Controller
    {
        ...
        public GruposController(TareasDBv3Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Grupos != null ? 
                          ...
                          Problem("Entity set 'TareasDBv3Context.Grupos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TareasDBv3Context.Grupos'  is null.");
            }
            var grupo = await _context.Grupos.FindAsync(id);
            if (grupo != null)
            {
